        ...
        <div class="col-md-6">
            <div class="card custom--shadow">
                <div class="card-header text-center base--bg p-3">
                    <span><?php echo app('translator')->get('Flutterwave'); ?></span>
                </div>
                <div class="card-body">
                    ...
                    <button type="button" class="btn cmn-btn w-100 mt-3" id="btn-confirm" onClick="payWithRave()"><?php echo app('translator')->get('Pay Now'); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\donations\core\resources\views/templates/basic/user/payment/Flutterwave.blade.php ENDPATH**/ ?>