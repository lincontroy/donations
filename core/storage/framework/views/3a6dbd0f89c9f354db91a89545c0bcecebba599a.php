...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    ...
    <a class="btn btn-outline--primary h-45" href="<?php echo e(route('admin.gateway.manual.create')); ?>"><i class="las la-plus"></i><?php echo app('translator')->get('Add New'); ?></a>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\donations\core\resources\views/admin/gateways/manual/list.blade.php ENDPATH**/ ?>