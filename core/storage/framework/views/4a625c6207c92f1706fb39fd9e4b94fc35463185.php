                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="amount" class="form-control" value="<?php echo e(old('amount', $donation->donation)); ?>" autocomplete="off" readonly required>
                                ...
                                <button type="submit"  class="btn cmn-btn w-100 mt-3 submitConfirmation"><?php echo app('translator')->get('Submit'); ?></button>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\donations\core\resources\views/templates/basic/user/payment/deposit.blade.php ENDPATH**/ ?>