            ...
            <div class="col-md-8">
                <div class="card custom--shadow">
                    <div class="card-header text-center base--bg p-3">
                        <span><?php echo e(__($pageTitle)); ?></span>
                    </div>
                    <div class="card-body  ">
                        <form action="<?php echo e(route('deposit.manual.update')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<?php endif; ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn cmn-btn w-100"><?php echo app('translator')->get('Pay Now'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<?php echo $__env->make($activeTemplate.'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\donations\core\resources\views/templates/basic/user/payment/manual.blade.php ENDPATH**/ ?>